...
function placeXOrO(squareNumber) {
   ...
   //This function results in a random square being selected by the computer.
    function computersTurn() {
        ...
        while (!success) {
            //A random number bewteen 0 and 8 is selected.
...
//drawLine() function is called to draw a line of the screen if the condition is met.
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 variables we pass are included in our array then
 ...
 function disableClick() {
    ...
    body.style.pointerEvenets = 'none';
 ...
 function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        y1 = coordY1,
        //Ths line indicates where the end of a lines x axis is.
        x2 = coordX2,
    ...
    //This function interactd with the canvas.
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            //This is necassary for the 6, 4, 2 win conditions.
